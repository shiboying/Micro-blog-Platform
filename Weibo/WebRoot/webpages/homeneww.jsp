<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*" import="com.weibo.domain.User" errorPage="" %>
...
<body>
    ...
    <div id="templatemo_menu_panel">
    	<div id="templatemo_menu_section">
            <ul>
                <li><a href="./webpages/index.html"  class="current">首页</a></li>
                <li><a href="#">个人主页</a></li>
                <li><a href="#">搜索好友</a></li>  
                <li><a href="#">照片库</a></li>
                <li><a href="#">关于我们</a></li> 
